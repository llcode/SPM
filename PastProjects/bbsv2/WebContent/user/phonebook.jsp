			...
			<div id="content" class="span10">
				...
				<div>
					<ul class="breadcrumb">
						...
						<a href="userCountService!goUserCenter">个人中心</a>
						<span class="divider">/</span>
						<a href="userCountService!goPhoneBook">通讯录</a></li>
					</ul>
				</div>
				<div>
					<s:form action="userCountService!searchUserinfo" method="post">
				姓名 :
				<input type="text" name="sname" size=15 maxlength=15>
			班级 :<input type="text" name="className" size=15 maxlength=15>
					...
					<div class="box span12">
						<div class="box-content">
							...
							<table class="table table-bordered" style="width: 80%">
								<thead>
									<tr class="warning">
										<th align=left class="center">学号</th>
										<th align=left class="center">姓名</th>
										<th align=left class="center">性别</th>
										<th align=left class="center">生日</th>
										<th align=left class="center">QQ</th>
										<th align=left class="center">手机</th>
										<th align=left class="center">邮箱</th>
										<th align=left class="center">班级</th>
										<th align=left class="center">宿舍</th>
										<th align=left class="center">家乡</th>
									</tr>
								</thead>
								<tbody>
									<s:iterator value="userinfoList">
										<tr>
											<td align=left><s:property value="sno" /></td>
											<td align=left><s:property value="sname" /></td>
											<td align=left><s:property value="gender" /></td>
											<td align=left><s:property value="birthday" /></td>
											<td align=left><s:property value="QQ" /></td>
											<td align=left><s:property value="Tel" /></td>
											<td align=left><s:property value="email" /></td>
											<td align=left><s:property value="classname" /></td>
											<td align=left><s:property value="dormtary" /></td>
											<td align=left><s:property value="hometown" /></td>
										</tr>
									</s:iterator>
								</tbody>
							</table>

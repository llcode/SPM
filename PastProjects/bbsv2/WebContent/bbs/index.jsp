				...
				<div class="box span12">
					...
					<table class="table table-striped table-bordered bootstrap-datatable datatable">
						<thead>
							<tr>
								<th width="5%">序号</th>
								<th class="center"width="10%" >版块名称</th>
								<th width="55%">版块介绍</th>
								<th width="6%">版主</th>
								<th >主贴数/回帖数</th>
								<th class="center">最后发帖时间</th>
							</tr>
						</thead>
						<tbody>
							<s:iterator value="sections" status="st">
								<tr>
									...
									<td ><a
										href="bbsService!goInTo?section.sectionid=<s:property value="sectionid" />">
											<s:property value="name" />
									</a></td>
									<td><s:property value="description" /></td>
									<td><s:iterator value="managers">
											<a
												href="empService!goInUser?usercount.userid=<s:property value="userid" />">
												<s:property value="username" /><br>
											</a>
										</s:iterator></td>
									<td><s:property value="topics.size" />/<s:property
											value="topics.{replys}.size" /></td>
					      ...
					      <div class="span12 center">
					          ...
					          <ul>
					            <li class="prev disabled"><a href="#">← Previous</a>
					               ...
					               </li><li><a href="#">2</a></li><li><a href="#">3</a></li><li><a href="#">4</a></li><li class="next"><a href="#">Next → </a></li></ul>
					          </div>
					      </div>
				   </div>
				<!--  	

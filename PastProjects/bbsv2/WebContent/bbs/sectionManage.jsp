...
<script type="text/javascript">
	function goEditSection(sectionid) {
		window.location.href = "bbsService!goEditSection?section.sectionid="
				+ sectionid;
	}
	function delSection(sectionid) {
		window.location.href = "bbsService!delSection?section.sectionid="
				+ sectionid;
	}
</script>
</head>
				...
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link"
							href="/bbsv2/album/albumService!goAlbumIndex"><i
								class="icon-edit"></i><span class="hidden-tablet"> 相册</span></a></li>
						<li><a class="ajax-link"
							href="/bbsv2/userCountService!goUserCenter"><i
			...
			<div id="content" class="span10">
				<div>
					<ul class="breadcrumb">
						...
						<li><a href="bbsService!goSectionManage">版块管理</a></li>
					</ul>
				</div>
				<div>
					<s:form action="bbsService!editSection">
						<table class="table table-striped table-bordered bootstrap-datatable datatable" >
							...
							<tbody>
								<s:iterator value="sections" status="st">
									<tr>
										<td ><s:property value="#st.index+1" /></td>
										<td ><a
											href="bbsService!goEditSection?section.sectionid=<s:property value="sectionid" />">
												<s:property value="name" />
										</a></td>
										<td ><s:property value="description" /></td>
										<td ><s:if test="status==1"><span class="label label-success">Active</span></s:if> <s:else><span class="label label-important">Banned</span></s:else></td>
										<td class="center" ><button type="button" class="btn"
												onclick="goEditSection(<s:property value="sectionid" />)">更新</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<button type="button" class="btn"
												onclick="delSection(<s:property value="sectionid" />)">删除</button></td>
									</tr>
								</s:iterator>
							</tbody>
						</table>

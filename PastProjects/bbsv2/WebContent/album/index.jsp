				...
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link"
							href="/bbsv2/bbs/bbsService!goBbsIndex"><i
								class="icon-eye-open"></i><span class="hidden-tablet">&nbsp;&nbsp;BBS</span></a></li>
						<li><a class="ajax-link" href="albumService!goAlbumIndex"><i
			...
			<div id="content" class="span10">
				<div>
					<ul class="breadcrumb">
						...
						<li><a href="albumService!goAlbumIndex">Albums</a></li>
					</ul>
				</div>
				<div>
					<button type="button" class="btn btn-primary"
						onclick="goAddSection()">新增相册</button>
					<button type="button" class="btn btn-primary"
						onclick="goSectionManage()">相册管理</button>
					<br> <br> 公共
					<table border="1">
						<thead>
							<tr>
						...
						<tbody>
							<s:iterator value="pubAlbums" status="st">
								<tr>
									<td><s:property value="#st.index+1" /></td>
									<td><a
										href="empService!goInTo?section.sectionid=<s:property value="sectionid" />">
											<s:property value="name" />
									</a></td>
									<td><s:property value="description" /></td>
									<td><s:property value="photos.size" /></td>
								</tr>
							</s:iterator>
						</tbody>
					</table>
					...
					<table border="1">
						...
						<tbody>
							<s:iterator value="myAlbums" status="st">
								<tr>
									<td><s:property value="#st.index+1" /></td>
									<td><a
										href="empService!goInTo?section.sectionid=<s:property value="sectionid" />">

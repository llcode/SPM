			...
			<div>
				<ul class="breadcrumb">
					<li><a href="/bbsv2/index.jsp">首页</a> <span class="divider">/</span>
						...
						class="divider">/</span>
					<li><a href="userCountService!goUserEdit">个人信息编辑</a></li>
				</ul>

				<center>
					<h2>
						<font color=orange><b>个人信息编辑</b></font>
					</h2>
					<hr>
				</center>
				<div class="box-content">

					<form class="form-horizontal" action="userCountService!useredit"
						method="post">
						<fieldset>
							<input type="hidden" name="user.userid">
							<div class="control-group">
								<label class="control-label">请输入您的昵称:</label>
								<div class="controls">
									<s:textfield class="span12 typeahead" size="100" type="text"
										name="user.username"></s:textfield>
									<input type="hidden" name="user.userid">
									<input type="hidden" name="userinfo.userinfoid">
								</div>
							</div>


							<div class="control-group">
								<label class="control-label">请输入您的真实姓名:</label>
								<div class="controls">
									<s:textfield class="input-xlarge focused" readonly="true"
										disabled="disabled" name="userinfo.sname"></s:textfield>
								</div>
							</div>
							<div class="control-group">
								<label class="control-label">请输入您的学号:</label>
								<div class="controls">
									<s:textfield class="input-xlarge focused" readonly="true"
										name="userinfo.sno"></s:textfield>
								</div>
							</div>
							<div class="control-group">
								<label class="control-label">请输入您的生日:</label>
								<div class="controls">
									<s:textfield class="input-xlarge focused"
										name="userinfo.birthday"></s:textfield>

								</div>
							</div>

							<div class="control-group">
								<label class="control-label">请输入您的常用QQ号:</label>
								<div class="controls">
									<s:textfield class="input-xlarge focused" name="userinfo.QQ"></s:textfield>
								</div>
							</div>

							<div class="control-group">
								<label class="control-label">请输入您的手机号:</label>
								<div class="controls">
									<s:textfield class="input-xlarge focused" name="userinfo.Tel"></s:textfield>
									
								</div>
							</div>
							<div class="control-group">
								<label class="control-label">请输入您的常用邮箱:</label>
								<div class="controls">
									<s:textfield class="input-xlarge focused" name="userinfo.email"></s:textfield>
								</div>
							</div>
							<div class="control-group">
								<label class="control-label">请输入您的宿舍号:</label>
								<div class="controls">
									<input type="hidden" name="user.userid"> <input
										type="hidden" name="userinfo.userinfoid">
									<s:textfield class="input-xlarge focused"
										name="userinfo.dormitory"></s:textfield>
								</div>
							</div>
							<div class="control-group">
								<label class="control-label">请输入您的家乡:</label>
								<div class="controls">
									<s:textfield class="input-xlarge focused"
										name="userinfo.hometown"></s:textfield>
									<input type="hidden" name="user.userid">
								</div>
							</div>
							<div class="control-group">

...
<script type="text/javascript">
	function goEditUser() {
		window.location.href = "userCountService!goUserEdit";
	}

	function goUserManageList() {
		window.location.href = "userCountService!goManagerList";
	}
	function goPhoneBook() {
		window.location.href = "userCountService!goPhoneBook";
	}
	function goEditPwd() {
		window.location.href = "userCountService!goPwd";
	}
</script>
	...
	<div class="span2 main-menu-span">
		<div class="well nav-collapse sidebar-nav">
			<ul class="nav nav-tabs nav-stacked main-menu">
				...
				<li><a class="ajax-link" href="album/albumService!goAlbumIndex"><i
						class="icon-edit"></i><span class="hidden-tablet">&nbsp;&nbsp;Album</span></a></li>
				<li><a class="ajax-link" href="userCountService!goUserCenter"><i
						class="icon-list-alt"></i><span class="hidden-tablet"> 个人中心</span></a></li>
			</ul>
	...
	<div id="content" class="span10">
		...
		<div>
			<ul class="breadcrumb">
				...
				<li><a href="userCountService!goUserCenter">UserCenter</a></li>
			</ul>
		</div>
		<!--/.fluid-container-->
		<button type="button" class="btn btn-primary" onclick="goEditUser()">修改用户</button>
		<button type="button" class="btn btn-primary"
			onclick="goUserManageList()">用户列表</button>
		<button type="button" class="btn btn-primary" onclick="goPhoneBook()">通讯录</button>
		<button type="button" class="btn btn-primary" onclick="goEditPwd()">修改密码</button>
		<br> <br>

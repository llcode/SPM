		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				<li><a href="/bbsv2/index.jsp">首页</a> <span class="divider">/</span>
					...
					class="divider">/</span>
				<li><a href="userCountService!goPwd">修改密码</a></li>

			</ul>

			<center>
				<h2>
					<font color=orange><b>修改密码</b></font>
				</h2>
				<hr>
			...
			<div class="box-content">
				...
				<form class="form-horizontal" action="userCountService!updatePwd">
					<fieldset>
						...
						<div class="control-group">
							...
							<div class="controls">
								<s:password class="input-xlarge focused" name="newPwd1"></s:password>
								<input type="hidden" name="user.userid">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">请再次输入您的新密码:</label>
							<div class="controls">
								<s:password class="input-xlarge focused" name="newPwd2"></s:password>
							</div>
						</div>

			...
			<div id="content" class="span10">
				<div>
					<ul class="breadcrumb">
						...
						<li><a
							href="bbsService!goEditSection?section.sectionid=<s:property value="section.sectionid" />">版块更新</a></li>
					</ul>
				</div>
				<div>
					<s:form action="bbsService!editSection">
						...
						<table border="1">
							<tbody>
								<tr>
									...
									<td><select name="userids" multiple="multiple">
											<s:iterator value="userCounts">
												<s:if test="managers.{userid}.contains(#this.userid)">
								...
								<tr>
									<td>版块名</td>
									<td><s:textfield name="section.name" theme="simple"></s:textfield></td>
								</tr>
								<tr>
									<td>版块描述</td>
								...
								<tr>
									<td>版块状态</td>
									<td><s:if test="section.status==1">
						正常<input type="radio" name="section.status" value="1"
												checked="checked">
							废除<input type="radio" name="section.status" value="0">
										</s:if> <s:else>正常<input type="radio" name="section.status"
												value="1">
							废除<input type="radio" name="section.status" checked="checked"
												value="0">
										</s:else></td>
								</tr>
							</tbody>
						...
						<br>
						<br>
						<s:submit value="更新" theme="simple" cssClass="btn btn-primary"></s:submit>
